...
- It make sure that number of replica = number of nodes and each noden has one running replica everytime. If we delete it then controller will re-create it.
